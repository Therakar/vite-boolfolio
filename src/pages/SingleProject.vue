...
<template>
    <div v-if="project" class="card w-50 h-25 m-auto" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <div class="card-text">
                <div v-if="project.technologies.length > 0">
                    ...
                    <span class="badge text-bg-dark me-1" v-for="technology in project.technologies">{{technology.name}}</span>
                </div>
                <div v-else>
                    <strong class="me-2">Technology:</strong>
